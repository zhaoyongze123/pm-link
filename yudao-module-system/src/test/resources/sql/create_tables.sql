...
CREATE TABLE IF NOT EXISTS "system_meeting_booking" (
    ...
    "force_conflict" bit NOT NULL DEFAULT FALSE,
    "cancel_reason" varchar(500) DEFAULT NULL,
    "cancel_type" tinyint DEFAULT NULL,
    "creator" varchar(64) DEFAULT '',
    "create_time" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updater" varchar(64) DEFAULT '',
    "update_time" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS "system_personal_schedule" (
    ...
    "other_participants" varchar(500) DEFAULT NULL,
    "creator" varchar(64) DEFAULT '',
    "create_time" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updater" varchar(64) DEFAULT '',
    "update_time" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS "system_kod_sso_user_bind" (
   "id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
   "user_id" bigint NOT NULL,
   "kod_user_id" varchar(128) NOT NULL,
   "kod_username" varchar(128) DEFAULT '',
   "kod_nickname" varchar(128) DEFAULT '',
   "raw_profile_json" varchar(4000) DEFAULT '',
   "creator" varchar(64) DEFAULT '',
   "create_time" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
   "updater" varchar(64) DEFAULT '',
   "update_time" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
